...
func (gui *Gui) GetInitialKeybindings() []*Binding {
	bindings := []*Binding{
		...
		},
		{
			...
			Key:         'D',
			Modifier:    gocui.ModNone,
			Handler:     gui.handleDeleteSelected,
			Description: gui.Tr.DeleteSelected,
		},
		{
			ViewName:    "project",
			Key:         'e',
		...
		},
		{
			...
			Key:         gocui.KeySpace,
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleToggleContainerSelection),
			Description: gui.Tr.ToggleSelect,
		},
		{
			ViewName:    "containers",
			Key:         'v',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleSelectAllContainers),
			Description: gui.Tr.SelectAll,
		},
		{
			ViewName:    "containers",
			Key:         'V',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleDeselectAllContainers),
			Description: gui.Tr.DeselectAll,
		},
		{
			ViewName:    "services",
			Key:         'u',
		...
		},
		{
			...
			Key:         gocui.KeySpace,
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleToggleImageSelection),
			Description: gui.Tr.ToggleSelect,
		},
		{
			ViewName:    "images",
			Key:         'v',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleSelectAllImages),
			Description: gui.Tr.SelectAll,
		},
		{
			ViewName:    "images",
			Key:         'V',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleDeselectAllImages),
			Description: gui.Tr.DeselectAll,
		},
		{
			ViewName:    "volumes",
		...
		},
		{
			...
			Key:         gocui.KeySpace,
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleToggleVolumeSelection),
			Description: gui.Tr.ToggleSelect,
		},
		{
			ViewName:    "volumes",
			Key:         'v',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleSelectAllVolumes),
			Description: gui.Tr.SelectAll,
		},
		{
			ViewName:    "volumes",
			Key:         'V',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleDeselectAllVolumes),
			Description: gui.Tr.DeselectAll,
		},
		{
			ViewName:    "networks",
		...
		},
		{
			...
			Key:         gocui.KeySpace,
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleToggleNetworkSelection),
			Description: gui.Tr.ToggleSelect,
		},
		{
			ViewName:    "networks",
			Key:         'v',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleSelectAllNetworks),
			Description: gui.Tr.SelectAll,
		},
		{
			ViewName:    "networks",
			Key:         'V',
			Modifier:    gocui.ModNone,
			Handler:     wrappedHandler(gui.handleDeselectAllNetworks),
			Description: gui.Tr.DeselectAll,
		},
		{
			ViewName:    "main",
